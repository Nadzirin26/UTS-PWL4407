...
<a type="button" class="btn btn-success" href="<?= base_url() ?>product/download">
        Download Data
</a>
<?php endif; ?>
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('product') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="weight">Berat (gram)</label>
                        <input type="number" name="weight" class="form-control" id="weight" placeholder="Berat Barang (gram)" required>
                    </div>
