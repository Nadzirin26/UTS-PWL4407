...
<head>
  ...
  <title>- Green House - <?php echo $hlm ?></title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="<?= base_url()?>NiceAdmin/assets/img/hijau.png" rel="icon">
  <link href="<?= base_url()?>NiceAdmin/assets/img/hijau.png" rel="apple-touch-icon">
